        ...
        return (
            <View style={[styles.oneCard,]}>
                ...
                <View style={{ width: (WIDTH / 2) - 23, }}>
                    ...
                    <MaterialIcons style={{ alignSelf: 'flex-end', marginRight: 5, marginBottom: 2 }} name="verified-user" size={20} color="green" type="MaterialIcons" />
        ...
        return (
            <View style={{ flex: 1, backgroundColor: 'white', position: 'relative', }}>
                <View style={{ flex: .07, backgroundColor: 'white', position: 'relative' }}>
                    <ProgressBar progress={CurrentIndex / this.props.route.params.question.length } color='#26c751' style={{ height: 6 }} />
                    {/* <Button title="asd" onPress={() =>  console.log(  )}/> */}
                </View>
